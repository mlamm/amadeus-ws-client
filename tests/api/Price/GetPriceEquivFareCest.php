 ...
 * This test is using an amadeus display-tst response where the base-fare is in currency *CHF*,
 * and the equiv-fare is in *EUR*.
 *
 * @author     Marcel Lamm <marcel.lamm@invia.de>
 * @copyright  Copyright (c) 2018 Invia Flights Germany GmbH
 */
class GetPriceEquivFareCest
{
    /**
    ...
    public function _before(ApiTester $I)
    {
        $this->phiremockHelper->prep(
            $I,
            codecept_data_dir('fixtures/Ticket_DisplayTST-EQUIV_FARE.xml')
        );
    }
