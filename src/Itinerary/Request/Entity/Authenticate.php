...
/**
 * entity for authentication header
 *
 * @package Flight\Service\Amadeus\Itinerary\Request\Entity
 */
class Authenticate
{
    /**
    ...
    {
        $this->setDutyCode($data->{'duty-code'})
             ->setOfficeId($data->{'office-id'})
             ->setOrganizationId($data->{'organization'})
             ->setPasswordData($data->{'password-data'})
