...
use Flight\RemarksRequestMapping\Entity\BusinessCase;
use Flight\RemarksRequestMapping\Entity\Leg;
use Flight\RemarksRequestMapping\Entity\Request;
...
class CacheKey
{
    ...
    private function createCacheKey(Request $request, BusinessCase $businessCase, \stdClass $config) : string
    {
        ...
        $values = [
            ...
            'is-area-remarks'     => $businessCase->getOptions()->isAreaRemarks(),
